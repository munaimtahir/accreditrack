...
class ProformaItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProformaItem
        fields = ['id', 'code', 'requirement_text', 'required_evidence_type', 'importance_level', 'created_at', 'updated_at']
...
class ProformaTemplateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'authority_name', 'description', 'version', 'is_active', 'sections', 'sections_count', 'created_at', 'updated_at']
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class ProformaTemplateListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProformaTemplate
        fields = ['id', 'title', 'authority_name', 'version', 'is_active', 'sections_count', 'created_at']

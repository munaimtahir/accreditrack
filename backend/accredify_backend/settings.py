"""
Django settings for AccrediFy project.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'accredify'),
        'USER': os.getenv('DB_USER', 'accredify'),
...
REST_FRAMEWORK = {
    ...
    # Don't require authentication globally - let views decide
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'AccrediFy API',
    'DESCRIPTION': 'Compliance and accreditation management platform API',
    'VERSION': '1.0.0',

...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ['id', 'name', 'description', 'created_at', 'updated_at', 'indicators_count', 'sections_count']
        read_only_fields = ['created_at', 'updated_at']
...
class EvidenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Evidence
        fields = ['id', 'indicator', 'title', 'file', 'url', 'notes', 'uploaded_by', 'uploaded_by_name', 'uploaded_at']
